...
with st.expander("⚖️ Impressum & Datenschutz"):
    st.markdown("""
    **Impressum (Anbieterkennzeichnung)** Dominik Giel 
    Badstr. 24 
    Offenburg 
    E-Mail: dominik.giel@hs-offenburg.de 
    
    **Datenschutz** Diese App speichert aktiv keine persönlichen Daten der Nutzer (keine Cookies, keine Datenbank). Bitte beachten Sie jedoch:  
